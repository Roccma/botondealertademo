...
$.ajax({
        url: "https://botondealerta-services.herokuapp.com/usuarios.php/VideollamadasActuales",
        type: 'GET',
        dataType: 'json'
    })
    .done(function(data) {
...
$('#opcionOpenTok').on('click', function() {
    ...
    $.ajax({
            url: 'https://botondealerta-services.herokuapp.com/usuarios.php/GetClaveTokBox',
            type: 'GET',
            dataType: 'json'
        })
...
$('#opcionServidores').on('click', function() {
    ...
    $.ajax({
            url: 'https://botondealerta-services.herokuapp.com/usuarios.php/GetServidores',
            type: 'GET',
            dataType: 'json'
        })
        .done(function(response) {
...
$('#btnAceptarServidores').on('click', function() {
    ...
    if (campoVacio) {
        ...
        $.ajax({
                url: 'https://botondealerta-services.herokuapp.com/usuarios.php/UpdateServidores?servidor_bda=' + $('#servidorBDA').val() + "&servidor_vet=" + $('#servidorVET').val() + "&servidor_respaldo_vet=" + $('#servidorRespaldoVET').val(),
                type: 'GET',
                dataType: 'json'
            })
            .done(function(response) {
...
$('#btnAceptarOpenTok').on('click', function() {
    ...
    $.ajax({
            url: 'https://botondealerta-services.herokuapp.com/usuarios.php/ClavesTokBox?apiKey=' + $('#otApiKey').val() + "&projectKey=" + $('#otSecretKey').val(),
            type: 'GET',
            dataType: 'json'
        })
        .done(function(response) {
...
function verificarFinalizarLlamada(sessionId, id) {
    jQuery.ajax({
            url: 'https://botondealerta-services.herokuapp.com/usuarios.php/EstadoLlamada?id=' + id,
            type: 'GET',
            dataType: 'json',
            async: false
        })
...
$('#btnAceptarConfirmacion').on('click', function() {
    ...
    window.setTimeout(function() {
        ...
        $.ajax({
                url: "https://botondealerta-services.herokuapp.com/usuarios.php/FinLlamada?callid=" + id + "&url=&date=&latitud=" + lat + "&longitud=" + lon,
                type: 'GET',
                dataType: 'json',
                async: false
            })
