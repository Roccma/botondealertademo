...
$.ajax({
        url: "https://botondealerta-services.herokuapp.com/usuarios.php/VideollamadasFinalizadas",
        type: 'GET',
        dataType: 'json'
    })
    .done(function(data) {
...
socket.on('finish_help', function(data) {
    $.ajax({
            url: "https://botondealerta-services.herokuapp.com/usuarios.php/DatosLlamadaTabla?id=" + data['id'],
            type: 'GET',
            dataType: 'json'
        })
...
function verLlamada(id) {
    ...
    jQuery.ajax({
            url: 'https://botondealerta-services.herokuapp.com/usuarios.php/DatosLlamadaPorId',
            type: 'GET',
            dataType: 'json',
            data: { 'id': id }
        })
