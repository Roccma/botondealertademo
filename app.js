...
io.on('connection', (socket) => {
    ...
    socket.on('help', (sessionId, token, cedula, name, email, telephone, latitud, longitud, fechaHora, cantidad_desconexiones, dias_persistencia) => {
        var url = "https://botondealerta-services.herokuapp.com/usuarios.php/DatosLlamada?userid=" + cedula + "&date=" + fechaHora + "&latitud=" + latitud + "&longitud=" + longitud + "&sessionid=" + sessionId + "&token=" + token + "&cantidad_desconexiones=" + cantidad_desconexiones + "&dias_persistencia=" + dias_persistencia;
    ...
    socket.on('finish_help_from_app', (sessionId, id, latitud, longitud) => {
        var url = "https://botondealerta-services.herokuapp.com/usuarios.php/FinLlamada?callid=" + id + "&url=&date=&latitud=" + latitud + "&longitud=" + longitud;
        console.log(url);
        request.get(url, (error, res, body) => {
            if (error)
                console.log(error);
